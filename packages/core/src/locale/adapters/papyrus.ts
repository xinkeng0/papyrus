//copy from https://github.com/vuetifyjs/vuetify/blob/master/packages/vuetify/src/locale/adapters/vuetify.ts
...
// Locales
import en from "@/locale/message/en";
import { consoleError, consoleWarn } from "@/util/console";
import { getObjectValueByPath } from "@/util/helper";
const LANG_PREFIX = "$papyrus.";
...
export function createPapyrusAdapter(options?: LocaleOptions): LocaleInstance {
